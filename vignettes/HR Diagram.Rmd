...
The following code will plot the interactive theoretical H-R diagram based on n = 55 stellar data points obtained from the McDonald Observatory data set.  The graph plots absolute magnitude by degrees Kelvin.
