...
HRDiagram is a R package used to produce the Hertzsprung-Russell (H-R) diagram for plotting stellar data.  Specifically, it can plot either an *observational* H-R diagram, which is based on apparent magnitude and stellar color (B-V index) or a *theoretical* H-R diagram, which is based on apparent magnitude and stellar temperature (degrees Kelvin).
...
The following code will plot the interactive theoretical H-R diagram based on n = 55 stellar data points obtained from the McDonald Observatory data set.
...
The following code will plot a non-interactive observational H-R diagram based on n = 6220 stellar data points obtained from the Yale Trigonometric Parallax Dataset.
