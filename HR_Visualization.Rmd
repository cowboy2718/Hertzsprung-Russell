...
mcdonaldstars%>%mutate(item_no= row.names(.))%>%select(constellation,star,apparent,absolute,temp,spectral_type, RA,Dec,notes) %>% 
  ...
  group_rows("Canis Major",8,10,label_row_css = "background-color: darkgreen; color: white;")%>%
  ...
  group_rows("Cygnus",22,24,label_row_css = "background-color: darkgreen; color: white;")%>%
  group_rows("Eridanus",25,26,label_row_css = "background-color: darkgreen; color: white;")%>%
  group_rows("Gemini",27,27,label_row_css = "background-color: darkgreen; color: white;")%>%
  group_rows("Indus",28,28,label_row_css = "background-color: darkgreen; color: white;")%>%
  group_rows("Leo",29,30,label_row_css = "background-color: darkgreen; color: white;")%>%
  group_rows("Lyra",31,31,label_row_css = "background-color: darkgreen; color: white;")%>%
  group_rows("Ophiuchus",32,32,label_row_css = "background-color: darkgreen; color: white;")%>%
  group_rows("Orion",33,34,label_row_css = "background-color: darkgreen; color: white;")%>%
  group_rows("Piscis austrinus",35,35,label_row_css = "background-color: darkgreen; color: white;")%>%
  group_rows("Sagittarius",36,36,label_row_css = "background-color: darkgreen; color: white;")%>%
  group_rows("Scorpius",37,37,label_row_css = "background-color: darkgreen; color: white;")%>%
  group_rows("Taurus",38,38,label_row_css = "background-color: darkgreen; color: white;")%>%
  group_rows("Ursa Major",39,42,label_row_css = "background-color: darkgreen; color: white;")%>%
  group_rows("Ursa Minor",43,43,label_row_css = "background-color: darkgreen; color: white;")%>%
  group_rows("Virgo",44,45,label_row_css = "background-color: darkgreen; color: white;")%>%
  group_rows("Unclassified",46,55,label_row_css = "background-color: darkgreen; color: white;")%>%
